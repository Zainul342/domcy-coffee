...
- [x] **Component**: Create `ReviewCard.tsx` (Single card UI).
  - [x] _Check_: Display avatar, name, stars, date?
- [x] **Component**: Create `ReviewsSection.tsx` (Container).
  - [x] _Check_: Is the "Stats Banner" (4.8 Stars) visible?
  - [x] _Check_: Do cards display in a grid/masonry?
...
- [x] **Component**: Create `InstagramCard.tsx`.
  - [x] _Check_: Does it look like a Polaroid?
  - [x] _Check_: Does hover show the heart icon?
- [x] **Component**: Create `InstagramSection.tsx`.
  - [x] _Check_: Logic for 3 columns on desktop / 2 on mobile.
  - [x] _Check_: Is the "Follow" button using the Amber color?
...
- [x] **Component**: Create `FeatureCard.tsx`.
  - [x] _Check_: Neumorphism style (soft shadows).
