...
const locationsData = [
  {
    ...
    openStatus: 'BUKA',
    hours: [{ day: 'Senin - Minggu', time: '10:00 - 23:00' }],
...
export const Locations = () => {
  ...
  return (
    <section
      id="locations"
      className="relative h-[80vh] w-full overflow-hidden bg-domcy-black border-t-4 border-domcy-cream"
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          ...
          {locationsData.map((loc) => (
            <Marker key={loc.id} position={loc.coordinates} icon={createCustomIcon()}>
      ...
      <div className="absolute top-0 left-0 h-full w-full sm:w-[450px] bg-domcy-green z-[1000] flex flex-col shadow-2xl">
        ...
        <div className="p-6 pb-4">
          ...
          <h2 className="font-display text-4xl text-domcy-cream uppercase tracking-wide">
            Lokasi Utama
          </h2>
        </div>
          ...
          {filteredLocations.map((loc) => (
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h3 className="font-display text-2xl text-domcy-cream uppercase tracking-wide mb-1">
                    {loc.name}
                  </h3>
                  <p className="font-sans text-domcy-cream/60 text-sm uppercase tracking-wider">
                    {loc.area}
                  </p>
                </div>
