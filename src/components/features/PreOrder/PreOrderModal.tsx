...
export const PreOrderModal = () => {
    ...
    const handleSendOrder = () => {
        ...
        if (!details.locationDetail.trim()) {
            alert(details.serviceType === 'dine-in' ? 'Mohon isi Nomor Meja' : 'Mohon isi Alamat Lengkap');
            return;
        }

        const serviceLabel = details.serviceType === 'dine-in' ? 'Makan di Tempat' : 'Bawa Pulang / Delivery';
                        ...
                        <div className="p-6 overflow-y-auto flex-1 text-domcy-cream">
                            {step === 'cart' ? (
                                ...
                                <div className="space-y-6">
                                    {/* Name Field */}
                                    <div>
                                        <label className="block font-sans font-bold text-sm mb-2 text-domcy-cream">Nama Lengkap *</label>
                                        <input
                                            type="text"
                                    ...
                                    {/* Service Type */}
                                    <div>
                                        <label className="block font-sans font-bold text-sm mb-3 text-domcy-cream">Pilihan Layanan *</label>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            placeholder={details.serviceType === 'dine-in' ? 'Contoh: Meja 12 (atau "Menunggu")' : 'Contoh: Jln. Raya Donomulyo No. 1...'}
                                    ...
                                    {/* Additional Note */}
                                    <div>
                                        <label className="block font-sans font-bold text-sm mb-2 text-domcy-cream">Catatan Tambahan (Opsional)</label>
                                        <textarea
