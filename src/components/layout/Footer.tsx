    ...
    <footer className="relative bg-domcy-cream text-domcy-green overflow-hidden">
      ...
      <div className="bg-domcy-green py-20 overflow-hidden relative">
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center justify-center leading-none">
            ...
            {/* Line 2: Outlined */}
            <div
              className="font-display text-[15vw] md:text-[8vw] text-transparent uppercase tracking-tight whitespace-nowrap"
      ...
      <div className="pt-16 pb-32 md:pb-16 flex flex-col items-center text-center relative">
        ...
        <div className="space-y-2 mb-12">
          <p className="font-sans font-bold text-domcy-green uppercase tracking-widest text-sm opacity-60">
            Established 2016
          </p>
          <p className="font-sans font-bold text-domcy-green uppercase tracking-widest text-xs opacity-40">
            Designed by Domcy Creative
          </p>
        </div>
        ...
        <div className="w-[90%] max-w-4xl grid grid-cols-1 md:grid-cols-3 border border-domcy-green/20 rounded-xl overflow-hidden shadow-lg bg-domcy-cream">
          ...
          <div className="p-6 border-b md:border-b-0 md:border-r border-domcy-green/20 flex flex-col items-center justify-center hover:bg-domcy-green/5 transition-colors group cursor-default">
            <span className="font-display text-2xl uppercase mb-1 group-hover:scale-105 transition-transform">
              Jam Buka
            </span>
            <span className="font-sans text-xs font-bold uppercase tracking-wider opacity-60">
          ...
          >
            <span className="font-display text-2xl uppercase mb-1 group-hover:scale-110 transition-transform">
              Pesan Sekarang
            </span>
            <span className="font-sans text-xs font-bold uppercase tracking-wider opacity-60 group-hover:opacity-80">
              Ambil & Delivery
            </span>
          </button>
