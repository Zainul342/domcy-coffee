  ...
  return (
    <>
      ...
      <div className="fixed top-4 left-0 right-0 z-[60] flex justify-center px-4">
        <nav
          className={`w-full max-w-[1400px] ${scrolled ? 'bg-domcy-cream/90 backdrop-blur-md' : 'bg-domcy-cream'} text-domcy-green rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] px-4 py-3 sm:px-6 sm:py-4 flex justify-between items-center transition-all duration-300`}
        >
          {/* 1. Left: Logo */}
          ...
          <div className="hidden lg:flex items-center gap-2">
            <button
              ...
              className="font-display text-base uppercase tracking-wider text-domcy-green border border-transparent hover:border-domcy-green rounded-xl px-5 py-2 transition-all"
            >
              Menu
            </button>
            <button
              ...
              <div className="w-full bg-domcy-cream text-domcy-green rounded-2xl shadow-2xl overflow-hidden flex flex-col h-full border border-domcy-green/10">
                <div className="flex justify-between items-center px-4 py-3 sm:px-6 sm:py-4 border-b border-domcy-green/10 bg-domcy-cream">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-display text-2xl sm:text-3xl text-domcy-green tracking-tighter">
                      domcy
                      <span className="text-sm font-sans font-bold mt-1 ml-0.5 opacity-60">®</span>
                    </span>
                  </div>
                  <div className="flex items-center gap-2 sm:gap-3">
                    <button
                    ...
                    <button
                      onClick={() => setIsOpen(false)}
                      className="bg-transparent text-domcy-green p-2 hover:rotate-90 transition-transform duration-300 flex items-center justify-center"
                    >
                ...
                <div className="p-6 bg-domcy-green/5 flex justify-between items-center text-domcy-green">
                  <div className="flex gap-4">
                    <span className="font-sans font-bold uppercase tracking-wider text-xs opacity-60">
                      Ikuti Kami
                    </span>
                    <a
